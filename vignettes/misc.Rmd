...
```{r eval = FALSE}
test_norm(mg_counts, mg_sample_info$diet, mg_sample_info$treatment)
```

This will create tier1, tier2, and tier3 in your r environment, and you can use them as 
you like. 

In the case of two groups: 

You'll again have some data:
...
```{r eval = FALSE}
two_group_test_norm(tg_counts, tg_sample_info$group)
```

This will again create tier1, tier2, and tier3 in your r environment, and you can use them as 
you like. 
